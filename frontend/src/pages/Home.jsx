...
export default function Home(){
    ...
    return (
        <main className="bg-slate-900 w-full min-h-dvh text-gray-300 flex flex-col items-center bg-[url('./assets/ttt-bg-3.png')] bg-center bg-cover bg-no-repeat text-center">
            ...
            className="md:w-96 w-72 text-center md:py-5 py-3 bg-stone-900 text-lime-400 md:hover:bg-slate-500 transition-all font-bold rounded-xl text-2xl mb-10 font-mono select-none">
                Singleplayer
            </Link>
            <button onClick={generateGameLink}
            className="md:w-96 w-72 text-center md:py-5 py-3 bg-stone-900 text-lime-400 font-bold md:hover:bg-slate-500  transition-all rounded-xl text-2xl font-mono select-none cursor-pointer">
                Multiplayer
            </button>
